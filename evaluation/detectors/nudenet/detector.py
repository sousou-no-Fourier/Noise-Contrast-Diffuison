...
class NudeDetector:
    def __init__(self, model_path=None):
        ...
        # Bundled ONNX weights, loaded relative to this file (was a hardcoded
        # absolute path in the original RECE copy).
        if model_path is None:
            model_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "best_new.onnx")
